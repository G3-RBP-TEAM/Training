...
(function (global, factory) {
  ...
  var Modal = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._setScrollbar = function _setScrollbar() {
      ...
      if (this._isBodyOverflowing) {
        ...
        SelectorEngine__default['default'].find(SELECTOR_FIXED_CONTENT).forEach(function (element) {
          ...
          Manipulator__default['default'].setDataAttribute(element, 'padding-rightContent', actualPadding);
        ...
        SelectorEngine__default['default'].find(SELECTOR_STICKY_CONTENT).forEach(function (element) {
          ...
          Manipulator__default['default'].setDataAttribute(element, 'margin-rightContent', actualMargin);
          element.style.marginRight = Number.parseFloat(calculatedMargin) - _this11._scrollbarWidth + "px";
        }); // Adjust body padding

        var actualPadding = document.body.style.paddingRight;
        var calculatedPadding = window.getComputedStyle(document.body)['padding-rightContent'];
        Manipulator__default['default'].setDataAttribute(document.body, 'padding-rightContent', actualPadding);
    ...
    _proto._resetScrollbar = function _resetScrollbar() {
      ...
      SelectorEngine__default['default'].find(SELECTOR_FIXED_CONTENT).forEach(function (element) {
        var padding = Manipulator__default['default'].getDataAttribute(element, 'padding-rightContent');

        if (typeof padding !== 'undefined') {
          Manipulator__default['default'].removeDataAttribute(element, 'padding-rightContent');
          element.style.paddingRight = padding;
        }
      }); // Restore sticky content and navbar-toggler margin

      SelectorEngine__default['default'].find("" + SELECTOR_STICKY_CONTENT).forEach(function (element) {
        var margin = Manipulator__default['default'].getDataAttribute(element, 'margin-rightContent');

        if (typeof margin !== 'undefined') {
          Manipulator__default['default'].removeDataAttribute(element, 'margin-rightContent');
          element.style.marginRight = margin;
        }
      }); // Restore body padding

      var padding = Manipulator__default['default'].getDataAttribute(document.body, 'padding-rightContent');

      if (typeof padding === 'undefined') {
        document.body.style.paddingRight = '';
      } else {
        Manipulator__default['default'].removeDataAttribute(document.body, 'padding-rightContent');
